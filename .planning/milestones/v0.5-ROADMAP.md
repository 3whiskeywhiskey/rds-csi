...
Plans:
- [ ] 10-01-PLAN.md — Prepare commits (DCO sign-off, rebase on main, clean focused test markers)
- [ ] 10-02-PLAN.md — Open PR and handle initial review

**Details:**
- Follow KubeVirt contribution guidelines (DCO sign-off mandatory)
- Reference issues #6564, #9708, #16520
- Include detailed PR description with before/after explanation
- Include release notes block for user-facing changelog
- Be prepared for `/ok-to-test` approval wait (first-time contributor)
