...
- 🚧 **v0.6.0 Block Volume Support** - Phases 11-13 (in progress)
...
Plans:
- [ ] 14-01-PLAN.md — NQN prefix validation and configurable filtering
- [ ] 14-02-PLAN.md — Safe procmounts parsing with timeout and duplicate detection
- [ ] 14-03-PLAN.md — Circuit breaker and filesystem health checks
- [ ] 14-04-PLAN.md — Graceful shutdown and deployment configuration
...
| 14. Error Resilience | v0.6.0 | 0/4 | Not started | - |
