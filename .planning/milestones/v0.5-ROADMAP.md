...
- 🚧 **v0.6.0 Block Volume Support** - Phases 11-14 (in progress)
...
### 🚧 v0.6.0 Block Volume Support (In Progress)
...
Plans:
- [ ] 13-01-PLAN.md — Hardware validation on metal cluster
...
### 📋 v0.7.0 State Management Refactoring (Planned)

**Milestone Goal:** Use Kubernetes VolumeAttachment objects as source of truth for attachment state
...
Plans:
- [ ] 15-01-PLAN.md — VolumeAttachment watcher and list/watch implementation
- [ ] 15-02-PLAN.md — Rebuild attachment state from VolumeAttachment objects on startup
- [ ] 15-03-PLAN.md — Grace period detection from multiple VolumeAttachment objects
- [ ] 15-04-PLAN.md — Testing: controller restart scenarios, stale annotation handling

## Progress

**Execution Order:**
Phases execute in numeric order: 11 → 12 → 13 → 14 → 15 (planned)
...
| 13. Hardware Validation | v0.6.0 | 0/1 | In progress | - |
| 14. Error Resilience | v0.6.0 | 4/4 | Complete | 2026-02-03 |
| 15. VolumeAttachment-Based State | v0.7.0 | 0/4 | Planned | - |
