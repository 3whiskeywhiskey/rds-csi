...
- v0.7.0 State Management Refactoring and Observability - Phases 15-16 (planned)
...
Block volume support for KubeVirt VMs, live migration validated on metal cluster, mount storm prevention, and comprehensive error resilience.

**Full details:** [.planning/milestones/v0.6.0-ROADMAP.md](milestones/v0.6.0-ROADMAP.md)
...
Plans:
- [x] 16-01-PLAN.md - Wire AttachmentManager.SetMetrics() in driver initialization
