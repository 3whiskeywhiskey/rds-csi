...
Last activity: 2026-02-03 — Milestone v0.5.0 requirements defined
...
- **v0.4.1** — shipped 2026-02-03
  - AllowedBasePaths refactoring (configurable only, no hardcoded paths)
...
Research findings for v0.5.0:
- RWX must be block-only (filesystem dual-mount causes corruption)
- Split-brain risk during network partitions (NVMe/TCP has no storage-level fencing)
- Need to test RDS multi-initiator behavior on actual hardware

## Session Continuity

Last session: 2026-02-03
Stopped at: Requirements defined, creating roadmap for v0.5.0
Resume file: None

---
*State initialized: 2026-01-30*
*Last updated: 2026-02-03 — v0.5.0 requirements defined, creating roadmap*
